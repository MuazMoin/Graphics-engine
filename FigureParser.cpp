...
Figure FigureParser::parseWireframeFigure(const ini::Section &figure) {
    ...
    if (type == "Cube"){
        ...
        Figure newFigure = Platonic::createTetrahedron({newFigure.rotateX, newFigure.rotateY, newFigure.rotateZ}, newFigure.scale, newFigure.center, color);
        return newFigure;}
    else if (type == "Cylinder"){
        Figure newFigure = NotPlatonic::createCylinder({newFigure.rotateX, newFigure.rotateY, newFigure.rotateZ}, newFigure.scale, newFigure.center, color, 4, 1);
        return newFigure;}
    else if (type == "Cone"){
        Figure newFigure = NotPlatonic::createCone({newFigure.rotateX, newFigure.rotateY, newFigure.rotateZ}, newFigure.scale, newFigure.center, color, 4, 1);
        return newFigure;}
    else if (type == "Sphere"){
        Figure newFigure = NotPlatonic::createSphere({newFigure.rotateX, newFigure.rotateY, newFigure.rotateZ}, newFigure.scale, newFigure.center, color, 0);
        return newFigure;}
    else if (type == "Torus"){
